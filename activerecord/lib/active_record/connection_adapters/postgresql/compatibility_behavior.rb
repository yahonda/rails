  ...
  module ConnectionAdapters
    module PostgreSQL
      module CompatibilityBehavior # :nodoc: all
        ...
        # Runs the real change_column first (`super` reaches V6_1, whose
        # `yield` invokes the operation passed in as a block), then applies
        # :default / :null / :comment separately.
        class V5_1 < V5_2
          def change_column(table_name, column_name, type, **options)
